...
(function (window) {
  ...
  var mySelWidth = 2; //grootte rode kader van sleep vierkant
  var mySelBoxColor = "darkred"; // New for selection boxes
  var mySelBoxSize = 6; //grootte handles van sleep vierkant
  ...
  function myDblClick(e) {
    ...
    var width = 20; //grootte van nieuwe vierkant waneer klikt
    var height = 20;
    addRect(
      mx - width / 2,
      my - height / 2,
    ...
    alert('myTouchStart triggered');

    }

    function myTouchEnd(e) {
    alert('myTouchEnd triggered');

  }
    function myTouchMove(e) {
    alert('myTouchMove triggered');
